...
ApplicationWindow {
    ...
    Timer{
        ...
        onTriggered: {
            ...
            var ur0 = ''+unik.getHttpFile('https://github.com/nextsigner/espartanos/commits/master?r='+d.getTime())
    ...
    function prepMod(){
        ...
        if(xP.am.length===0){
            xEstado.text='Error al leer carpeta \n'+xP.folder
            return
        }
        if(mod==='undefined'){
